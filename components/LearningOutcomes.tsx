...
export const LearningOutcomes: React.FC<{ theme: 'light' | 'dark' }> = ({ theme }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-lg">
      {/* Header */}
      <div className="mb-8">
        <div className="inline-block mb-4 px-4 py-2 bg-amber-50 dark:bg-indigo-900/40 rounded-full border border-amber-200 dark:border-amber-800/40">
      ...
      {/* Key Capabilities */}
      <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-indigo-900/20 dark:to-indigo-900/10 border border-amber-200 dark:border-amber-800/40/50 rounded-2xl p-6">
