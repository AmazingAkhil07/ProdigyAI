  ...
  return (
    <div className="min-h-screen flex-1 p-10 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Your Stats */}
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-900/20 rounded-3xl border border-indigo-200 dark:border-indigo-800 p-8 mb-8 shadow-lg">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-4xl font-black text-indigo-600 dark:text-indigo-400 mb-2">{progress.completedTodos.length}</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-6 mt-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-200 dark:border-slate-700 bg-indigo-50/50 dark:bg-indigo-900/20">
                      <td className="py-3 px-4 font-bold text-indigo-600 dark:text-indigo-400">#1</td>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 text-center">
            <p className="text-3xl font-black text-indigo-600 dark:text-indigo-400 mb-2">
